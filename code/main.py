...
API_TOKEN = apitoken
categories = {"Once": 1, "Repeat": 2, "Once a day": 3, "Twice a day": 4, "Thrice a day": 5}
categoryId = 0
date = ''
time = ''
context = ''
...
def Add_Reminder(message):
    ...
    if value == '/Exit':
        ...
        msg = bot.reply_to(message, "Please select the per day intake for the new medicine:",reply_markup=markup)
...
def Add_Context(message):
    ...
    if value == '/Exit':
        ...
        msg = bot.reply_to(message, 'Which medicine is to be taken ?',reply_markup=markup)
